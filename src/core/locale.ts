...
export { default as ar } from 'date-fns/locale/ar'
export { default as arDZ } from 'date-fns/locale/ar-DZ'
export { default as arEG } from 'date-fns/locale/ar-EG'
export { default as arMA } from 'date-fns/locale/ar-MA'
export { default as arSA } from 'date-fns/locale/ar-SA'
export { default as arTN } from 'date-fns/locale/ar-TN'
export { default as az } from 'date-fns/locale/az'
...
export { default as bs } from 'date-fns/locale/bs'
...
export { default as deAT } from 'date-fns/locale/de-AT'
...
export { default as enIE } from 'date-fns/locale/en-IE'
export { default as enIN } from 'date-fns/locale/en-IN'
export { default as enNZ } from 'date-fns/locale/en-NZ'
export { default as enUS } from 'date-fns/locale/en-US'
export { default as enZA } from 'date-fns/locale/en-ZA'
...
export { default as eu } from 'date-fns/locale/eu'
...
export { default as frCH } from 'date-fns/locale/fr-CH'
export { default as gd } from 'date-fns/locale/gd'
...
export { default as ht } from 'date-fns/locale/ht'
...
export { default as jaHira } from 'date-fns/locale/ja-Hira'
export { default as ka } from 'date-fns/locale/ka'
export { default as kk } from 'date-fns/locale/kk'
export { default as km } from 'date-fns/locale/km'
export { default as kn } from 'date-fns/locale/kn'
export { default as ko } from 'date-fns/locale/ko'
export { default as lb } from 'date-fns/locale/lb'
export { default as lt } from 'date-fns/locale/lt'
export { default as lv } from 'date-fns/locale/lv'
export { default as mk } from 'date-fns/locale/mk'
export { default as mn } from 'date-fns/locale/mn'
export { default as ms } from 'date-fns/locale/ms'
export { default as mt } from 'date-fns/locale/mt'
export { default as nb } from 'date-fns/locale/nb'
export { default as nl } from 'date-fns/locale/nl'
export { default as nlBE } from 'date-fns/locale/nl-BE'
...
export { default as uz } from 'date-fns/locale/uz'
export { default as vi } from 'date-fns/locale/vi'
export { default as zhCN } from 'date-fns/locale/zh-CN'
export { default as zhHK } from 'date-fns/locale/zh-HK'
